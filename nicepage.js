 ...
 */
    ...
    12690: function(t, e, n) {
        "use strict";
        var i = n(16), GalleryLayout = n(12691), Filter;
    ...
    12719: function(t, e, n) {
        "use strict";
        var i = n(12720), o = n(12721), a = n(12727), s, u;
        new o(i).subscribe(),
        new a(i).subscribe()
    },
    ...
    12721: function(t, e, n) {
        ...
        i.prototype.updateTotalPrice = function t(e) {
            ...
            if (n.length) {
                ...
                if (i = Currency.format(i, currency, a),
                n.text(i),
                !this.isCart)
        ...
        i.prototype.fillItem = function t(e, product) {
            ...
            if (!g.length)
                g = e.find(".u-product-desc");
            g.text(n);
            var v = e.find(".u-product-sku p");
            if (!v.length)
                v = e.find(".u-product-sku");
            v.text(f),
    ...
    12734: function(t, e, n) {
        ...
        ProductsBuilder.prototype.buildProduct = function(listItem, data, t) {
            ...
            if (listItem.is(".u-product-control"))
                e = e.add(listItem);
            e.each(function(e, el) {
                var n = $(el)
                  , i = n.find(".u-product-title-link");
                if (i.length && !n.is(".u-image"))
    ...
    214: function(t, e, n) {
        ...
        Currency.format = function(t, e, n) {
            ...
            if (i.includes(this.currency.symbol))
                return i;
            else
                return this.maskFormat(t)
        }
        ,
        ...
        Currency.maskFormat = function(t) {
            var e;
            if (this.currency.mask)
                e = this.currency.mask;
            else if (this.currency.symbol)
                e = "{0} " + this.currency.symbol;
            else
                e = "{0} " + this.currency.code;
            return t = this.zeroCents ? t : Math.trunc(t),
            e.replace("{0}", t)
        }
        ,
        Currency.getCurrentProcessLang = function() {
            ...
            if ("object" == typeof app)
                lang = app.lang.current.get() || lang;
            return lang
        }
        ,
